...
It closes on **Tuesday December 1st, 2026** and e-mails introducing the buddy pairs will be sent on **Wednesday December 2nd.**

[{{< iconify bi:calendar-check >}} sign-up form](https://docs.google.com/forms/d/e/1FAIpQLSezYTYdBkZml0iX2mEsxeV0nukjGf19zrChL-_fBK0b6cCsqQ/viewform?usp=dialog){.btn .icon-link}
:::
::::
...
- Folks opt-in via this [sign-up form](https://docs.google.com/forms/d/e/1FAIpQLSezYTYdBkZml0iX2mEsxeV0nukjGf19zrChL-_fBK0b6cCsqQ/viewform?usp=dialog)
...
- Play some online games, e.g. some of those listed [here](https://www.thegamer.com/best-free-web-browser-party-games/)
