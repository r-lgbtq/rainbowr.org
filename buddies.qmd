...
It closes on **Monday June 2nd, 2025** and e-mails introducing the buddy pairs will be sent on **Tuesday June 3rd.**

`r icon_link(icon = "list",
text = "sign-up form",
url = "https://docs.google.com/forms/d/18lbn2jD-B2oj-pfMAfCMwLxaJJ1ssjkC502P2rz2aAo")`
:::
::::
