...
It closes on **September 1st, 2024** and e-mails introducing the buddy pairs will be sent on **September 2nd, 2024**.

`r icon_link(icon = "list",
          text = "sign-up form",
          url = "https://docs.google.com/forms/d/1pYCUn3zlIsR5TozjLsl99ICKicQcdiCwcfcguCANpUw")`
